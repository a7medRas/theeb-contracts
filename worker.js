// Cloudflare Worker: يستقبل ملف PDF ويرفعه إلى Dropbox ثم يُرجع رابط مشاركة
export default {
  async fetch(request, env) {
    // ===== CORS (اسمّح فقط لدومين GitHub Pages الخاص بك) =====
    const allowed = [
      'https://YOUR_USER.github.io',            // ← غيّر YOUR_USER
      'https://YOUR_USER.github.io/theeb-contracts', // ← غيّر اسم المشروع لو مختلف
    ];
    ...
    try{
      // ===== اسم الملف والمسار داخل Dropbox =====
      ...
      return json({ ok:true, path: uploadJson.path_display, url: sharedUrl }, 200, cors);
    }catch(err){
